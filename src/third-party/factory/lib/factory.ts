...
import { Select } from 'src/third-party/factory/interfaces';
import { Overridable } from 'src/third-party/factory/lib/overridable';
import { FactoryRelationMetadata } from 'src/third-party/factory/decorators/factory-relation-field.decorator';
import { FACTORY_FIELD, FACTORY_RELATION } from 'src/third-party/factory/constants';
import { FactoryFieldMetadata } from 'src/third-party/factory/decorators/factory-field.decorator';
  ...
  private applyRelations<T = any>(entity: Type<T>, instance: T, select?: Select<T>) {
    ...
    for (const meta of relationFieldMetadata) {
      ...
      if (selectedField) {
        ...
        instance[meta.property] = this.new<unknown>(relationType, selectedField);
      }
    }
  }
